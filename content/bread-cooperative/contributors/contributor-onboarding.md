---
title: Bread Cooperative Contributor Onboarding
description: How to contribute to Bread Cooperative as an individual
fileClass: file
share: true
---

==**Building the necessary post-capitalist infrastructure of the future is no simple task but it’s one we’re willing to take on**== and we know we’re going to need a lot of help to make it happen. The revolution is a collective effort and we hope you’ll consider contributing how you think you best can. This page is meant to help you figure out how you can best help make a post-capitalist web3 possible in the Bread Cooperative Network.

# Who are we looking for contribution?

There are several ways one can begin contributing to Bread Cooperative. Of course before getting into contributions with your labor, anyone can contribute financially to the project by [baking BREAD](https://app.breadchain.xyz/) or donating through Open Collective (fiat) or [Giveth](https://giveth.io/project/breadchain-cooperative) (donate in crypto including BREAD).
...
Working in a democratic organization like Bread Cooperative is not like a traditional work environment and had different expectations than a hierarchical or corporate organization. This book is a good start as well as the practices professed by our friends at [Microsolidarity](https://www.microsolidarity.cc/) is another place to get a sense of what it means and how to succeed in this type of organizing.

# How to start contributing?

1. Join our [discord](https://cryptoleftists.xyz/), [guild](https://era.guild.xyz/breadcoop), follow on [twitter](https://x.com/breadcoop), etc.
2. Become familiar with Bread Cooperative by visiting our [website](https://bread.coop/), [baking BREAD](https://app.breadchain.xyz/), reading our [blog](https://breadchain.mirror.xyz/) / wiki, etc.
3. Check out our [Github page](https://github.com/breadchaincoop) if you’re a developer and read through how the crowdstaking application works
...
The core team is the most dedicated group of contributor towards Bread Cooperative app development and community building. It is also the team that has a right to the funds being given to the [[bread-co-op|Bread Core Team]] option in the governance app UI. The core team members are leaders around the management of the GitHub, the Bread Cooperative website, applications, social media pages, discord server, and more.
...
Core team members will also receive the Bread Core Team Team role in the crypto leftists discord server which will reveal the private channels where work is discussed. Core team members are expected to answer and respond to questions / requests in the server in a timely manner.

You can find more specific information in the [[operational-annex]] of the Bread Cooperative Constitution.

# Contributor Interest Form

[https://docs.google.com/forms/d/e/1FAIpQLSfOWubPChHH14LpV4GwgXrrot0Smqd1rmypN4MEULdw7n1o4g/viewform](https://docs.google.com/forms/d/e/1FAIpQLSfOWubPChHH14LpV4GwgXrrot0Smqd1rmypN4MEULdw7n1o4g/viewform)